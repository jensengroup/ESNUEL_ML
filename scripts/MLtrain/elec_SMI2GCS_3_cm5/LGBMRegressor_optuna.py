...
if __name__ == "__main__":
    ...
    ### REGRESSOR SETUP ###
    atom_descriptor = 'elec_SMI2GCS_3_cm5'
    target_type = 'MAA_values'
    ...
    df = pd.read_csv('/groups/kemi/ree/postdoc/applications/esnuelML/data/df_elec_x.csv.gz', index_col=0)
